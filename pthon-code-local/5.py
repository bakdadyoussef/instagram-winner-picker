...
class GiveawayApp:
    def __init__(self, root):
        self.root = root
        root.title("IG Giveaway Picker - Edge Navigator (429-proof, fixed)")
    ...
    # ------------------------------------------------------------
    #  LOAD COOKIES INTO INSTALOADER (unchanged)
    # ------------------------------------------------------------
    ...
    # ------------------------------------------------------------
    #  MAIN HARVEST (with retry backoff)
    # ------------------------------------------------------------
    ...
    def harvest_thread_func(self):
        ...
        for attempt in range(max_retries):
            try:
                ...
                raise
        self.log_msg("❌ All retries failed. Aborting.")
    ...
    def _do_harvest(self):
        ...
        # FIXED: Do NOT pass request_delay to __init__
        self.loader = instaloader.Instaloader(user_agent=ua)
        self.loader.request_delay = delay   # <--- THIS IS THE FIX
