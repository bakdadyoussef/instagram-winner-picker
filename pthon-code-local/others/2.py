...
# ================= CONFIGURATION =================
SESSION_FILE = "session_browser_edge.json"  # renamed to avoid confusion
# ================================================
...
class InstagramReelWinnerPicker:
    ...
    def setup_gui(self):
        ...
        # CHANGED: button text to reflect Edge
    ...
    async def browser_login_async(self):
        ...
        try:
            async with async_playwright() as p:
                # --- THE BIG CHANGE: use Edge instead of Chromium ---
                # channel="msedge" tells Playwright to use the installed Edge browser.
                # We also add a realistic Edge user‑agent.
                browser = await p.chromium.launch(
                    channel="msedge",          # <-- THIS IS THE MAGIC LINE
                    headless=False,
                    args=[
                        '--disable-blink-features=AutomationControlled',
                        '--disable-features=IsolateOrigins,site-per-process',
                        '--disable-web-security',  # sometimes helps with cross-domain
                    ]
                )
                # Create a context with Edge's latest user‑agent
                ...
                settings = {
                    ...
                    "device_settings": {
                        ...
                        "manufacturer": "Microsoft",   # pretending to be a Surface?
